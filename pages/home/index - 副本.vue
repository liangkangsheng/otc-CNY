	...
	<view class="content">
		...
		<view class="pay-true padding-30" v-show="!tabsOpenPay">
			<view :current="tabIndex" v-show="!tabsOpen">
				<view class="form-input">
					...
					<input type="number" :placeholder="this.minBuyAmtStr" v-model="BarPayPrice" @input="changeInput(BarPayPrice, '1')" />
					<text class="input-Eos">CNY</text>
				</view>
			</view>
			<view :current="tabIndex" v-show="tabsOpen">
				<view class="form-input" style="padding-left:10rpx;">
					<input type="number" :placeholder="this.minBuyCountStr" v-model="BarPayPriceNum" @input="changeInput(BarPayPriceNum, '2')" />
		...
		<view class="pay-false padding-30" v-show="tabsOpenPay">
			<view class="" :current="tabIndex" v-show="!tabsOpenM">
				<view class="form-input">
					<text class="pay-actives">￥</text>
					<input type="number" :placeholder="this.minSaleAmtStr" v-model="BarPayPrices" @input="changeInput(BarPayPrices, '3')" />
					<text class="input-Eos-1" style="color: #de6334;">CNY</text>
					<text class="input-Eos-2" @click="setMaxForSale">{{$t('index.text43')}}</text>
				</view>
			</view>
			<view class="" :current="tabIndex" v-show="tabsOpenM">
				<view class="form-input" style="padding-left:10rpx;">
					<input type="number" :placeholder="this.minSaleCountStr" v-model="BarPayPriceNums" @input="changeInput(BarPayPriceNums, '4')" />
