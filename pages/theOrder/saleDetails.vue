		...
		<view class="content">
			...
			<view class="back-wither height">
				<view class="payNum height">
					<input type="number" class="inputNum pull-left" :placeholder="$t('saleDetails.text5')" />
					<view class="usdt pull-left">USDT</view>
					<view class="all pull-right" @click="all(1)">{{ i18n.text4 }}</view>
				</view>
				<view class="payNum height">
					<input type="number" class="inputNum pull-left" :placeholder="$t('saleDetails.text6')" />
				...
				<view class="p height">
					...
					<view class="pull-right">0.00 USDT</view>
				</view>
				<view class="p height">
